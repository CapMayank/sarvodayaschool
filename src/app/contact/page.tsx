		...
		<>
			...
			<div className="max-w-7xl mx-auto px-4 py-16">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
					...
					>
						<div className="bg-gradient-to-r from-red-600 to-red-500 py-8 px-6">
					...
					<div className="bg-gray-50 p-6 border-t border-gray-200">
						...
						<div className="mt-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200 p-6 shadow-sm">
