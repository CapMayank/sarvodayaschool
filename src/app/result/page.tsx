		...
		<>
			...
			>
				<div className="text-center mb-16">
					<h2 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-600 mb-4">
					...
					<div className="w-40 h-1 bg-gradient-to-r from-red-500 to-red-600 mx-auto mt-6 rounded-full"></div>
				</div>
					...
					(className) => (
						<div key={className} className="mb-20">
							<div className="flex items-center gap-4 mb-8">
								...
								<h3 className="text-2xl md:text-3xl font-bold px-6 py-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 shadow-sm">
									Class {className}{" "}
									<span className="text-red-600">Toppers</span>
								</h3>
								<div className="flex-1 h-px bg-gradient-to-l from-gray-200 to-gray-300"></div>
							</div>
									...
									.map((topper, index) => (
										<motion.div
											...
											className={`relative overflow-hidden rounded-2xl w-[260px] mx-auto ${
												topper.special
													? "bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50 border-2 border-yellow-200"
													: "bg-white"
											} shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] transition-all duration-300 group`}
										>
											{topper.special && (
												<div className="absolute top-2 right-2 z-10">
													<span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-yellow-400 to-amber-500 text-white shadow-lg">
											...
											<div className="p-3 relative">
												{topper.special && (
													<div className="absolute -top-4 left-3 bg-gradient-to-r from-red-500 to-red-600 text-white px-2 py-0.5 rounded-full text-xs font-semibold shadow-lg">
														Special Achievement
													</div>
												)}
